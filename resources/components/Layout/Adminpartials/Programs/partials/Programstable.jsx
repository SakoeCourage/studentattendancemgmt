...
function Programstable({ data, isLoading, fetchData, filters, fullUrl, setViewById }) {
                ...
                <div className="flex flex-col w-full min-h-[36rem] h-max relative ">
                    <div className="flex items-center gap-3 w-full justify-end lg: px-10">
                        <div className='border rounded-lg flex items-center justify-between !w-96'>
                            <input onKeyDown={(e) => { e.key === 'Enter' && handleSearch() }} className='bg-transparent outline-none px-4 w-full' placeholder='Search program name' value={searchKey} onChange={(e) => setSearchKey(e.target.value)} type="search" />
